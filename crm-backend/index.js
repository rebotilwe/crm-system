...
// Also add logging to your existing endpoints

// Update your login endpoint to log the activity
app.post("/api/auth/login", async (req, res) => {
  const { email, password } = req.body;
...
// Update your add client endpoint to log activity
app.post("/api/clients", verifyToken, async (req, res) => {
  const {
    business_name,
    owner_name,
...
// Update your update client endpoint to log activity
app.put("/api/clients/:id", verifyToken, async (req, res) => {
  const {
    business_name,
    owner_name,
...
// Update your delete client endpoint to log activity
app.delete("/api/clients/:id", verifyToken, async (req, res) => {
  try {
...
// Update your CSV upload endpoint to log activity
app.post(
  "/api/clients/upload",
  verifyToken,
  upload.single("file"),
